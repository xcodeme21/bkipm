			...
			<div class="content-inner">
				...
				<div class="content">
					...
					<div class="card">
						<div class="card-body">
							<div class="col-xl-12">
								{{ Form::open(['route'=>'jenis-ikan.add', 'method' => 'POST']) }} 
								{{ Form::token() }}
								<div class="form-group form-group-floating row">
									<label class="col-form-label col-lg-2">Jenis Ikan</label>
									<div class="col-lg-10">
										<div class="position-relative">
											<input type="text" name="jenis_ikan" class="form-control form-control-outline" placeholder="Placeholder" required>
								...
								<div class="form-group form-group-floating row">
									...
									<div class="col-lg-10">
										<div class="position-relative">
											<input type="text" data-type="currency"  id="currency-field" name="harga" class="form-control form-control-outline" pattern="^\d{1,3}(,\d{3})*(\.\d+)?$" placeholder="Placeholder" required>
								...
								<div class="form-group form-group-floating row">
									...
									<a href="{{ route('jenis-ikan') }}" class="btn btn-warning">Batal</a>
								</div>
								{{ Form::close() }}
							</div>
						</div>
