			...
			<div class="content-inner">
				...
				<div class="content">
					...
					<div class="card">
						<div class="card-body">
							<div class="col-xl-12">
								{{ Form::open(['route'=>'jenis-usaha.update', 'method' => 'POST']) }} 
								{{ Form::token() }}
								<div class="form-group form-group-floating row">
									<label class="col-form-label col-lg-2">Nama</label>
									<div class="col-lg-10">
										<div class="position-relative">
											<input type="text" name="jenis_usaha" value="{{ @$rs->jenis_usaha }}" class="form-control form-control-outline" placeholder="Placeholder" required>
											<label class="label-floating">Masukkan nama brand</label>
								...
								<div class="form-group form-group-floating row">
									...
									<a href="{{ route('jenis-usaha') }}" class="btn btn-warning">Batal</a>
								</div>
								{{ Form::close() }}
							</div>
						</div>
