					...
					<div class="card">
						<div class="card-body">
							<div class="row-fluid" align="right">
								<a href="{{ route('ekspor.volume.tambah') }}" class="btn btn-primary">
									<i class="icon-add"></i> 
									Add New
								</a>
							</div>
										...
										<tbody>
											...
											<tr>
												...
												<td class="text-center">
													...
													<a href="{{ route('ekspor.volume.delete',[$rs->id]) }}" onclick="return confirm('Are you sure?')" class="btn btn-danger"><i class="icon-trash"></i> Delete</a>
												</td>
											</tr>
											@endforeach
										</tbody>
