						...
						<div class="card-body">
							<div class="col-xl-12">
								...
								<div class="form-group form-group-floating row">
									...
									<div class="col-lg-10">
										<div class="position-relative">
											<input type="text" name="name" value="{{ @$role->name }}" class="form-control form-control-outline" placeholder="Placeholder" required>
								...
								<div class="form-group form-group-floating row">
									...
									<a href="{{ route('roles') }}" class="btn btn-warning">Batal</a>
								</div>
								{{ Form::close() }}
							</div>
						</div>
