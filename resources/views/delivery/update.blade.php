			...
			<div class="content-inner">
				...
				<div class="content">
					...
					<div class="card">
						<div class="card-body">
							<div class="col-xl-12">
								{{ Form::open(['route'=>'delivery.update', 'method' => 'POST']) }} 
								{{ Form::token() }}
								<div class="form-group form-group-floating row">
									<label class="col-form-label col-lg-2">Delivery</label>
									<div class="col-lg-10">
										<div class="position-relative">
											<input type="text" name="delivery" value="{{ @$rs->delivery }}" class="form-control form-control-outline" placeholder="Placeholder" required>
