...
<body id="page-top">
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Frekuensi</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    ...
                                    <button class="btn btn-primary btn-sm">Total Frekuensi : {{ number_format(@$totalFrekuensi,0,',','.') }}</button>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        var frekuensi = <?php echo $frekuensi; ?>;
        var barChartData = {
            labels: year,
            datasets: [{
                label: 'Frekuensi',
