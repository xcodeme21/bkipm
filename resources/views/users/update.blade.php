						...
						<div class="card-body">
							<div class="col-xl-12">
								...
								<div class="form-group form-group-floating row">
									...
									<div class="col-lg-10">
										<div class="position-relative">
											<input type="text" name="name" value="{{ @$user->name }}" class="form-control form-control-outline" placeholder="Placeholder" required>
								...
								<div class="form-group form-group-floating row">
									...
									<div class="col-lg-10">
										<div class="position-relative">
											<input type="email" name="email" value="{{ @$user->email }}" class="form-control form-control-outline" placeholder="Placeholder" required>
								...
								<div class="form-group form-group-floating row">
									...
									<div class="col-lg-10">
										<div class="position-relative">
											<input type="text" name="username" value="{{ @$user->username }}" class="form-control form-control-outline" placeholder="Placeholder" required>
