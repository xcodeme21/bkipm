					...
					<div class="card">
						<div class="card-body">
							<div class="row-fluid" align="right">
								<a href="{{ route('stock-out.tambah') }}" class="btn btn-primary">
									<i class="icon-add"></i> 
									Add New {{ @$indexPage }}
								</a>
							</div>
										...
										<tbody>
											...
											<tr>
												...
												<td class="text-center">
													<a href="{{ route('stock-out.view',[$rs->id]) }}" class="btn btn-info btn-sm btn-block"><i class="icon-eye"></i> View</a>
													<a href="{{ route('stock-out.delete',[$rs->id]) }}" onclick="return confirm('Are you sure?')" class="btn btn-danger btn-sm btn-block"><i class="icon-trash"></i> Delete</a>
												</td>
											</tr>
											@endforeach
										</tbody>
